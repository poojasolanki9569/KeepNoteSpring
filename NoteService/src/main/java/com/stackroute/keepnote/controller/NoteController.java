...
public class NoteController {
	...
	public ResponseEntity<?> createReminder(@RequestBody Note note) {
	...
	public ResponseEntity<?> deleteReminder(@PathVariable String userId, @PathVariable int id) {
	...
	public ResponseEntity<?> updateReminder(@PathVariable String userId, @PathVariable int id, @RequestBody Note note) {
		note.setNoteCreationDate(new Date());
		try {
	...
	public ResponseEntity<?> getReminderbyId(@PathVariable String userId) {
	...
	public ResponseEntity<?> getReminderbyId(@PathVariable String userId, @PathVariable int noteId) {
		try {
			if (noteService.getNoteByNoteId(userId, noteId) != null) {
				return new ResponseEntity(noteService.getNoteByNoteId(userId, noteId), HttpStatus.OK);
			} else {
				return new ResponseEntity(HttpStatus.NOT_FOUND);
			}
		} catch (NoteNotFoundExeption e) {
